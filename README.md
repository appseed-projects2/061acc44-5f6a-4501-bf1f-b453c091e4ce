...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-07 20:32`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/061acc44-5f6a-4501-bf1f-b453c091e4ce.git
$ cd 061acc44-5f6a-4501-bf1f-b453c091e4ce
```
